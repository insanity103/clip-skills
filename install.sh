#!/usr/bin/env bash
# Install the eleven clip skills for Claude Code (Linux or macOS), set up their Python environment, then self-test.
...
SKILLS=(gameplay-clip-cutter vertical-clip-renderer clip-overlay-builder clip-audio-mixer clip-cover-picker clip-stylizer clip-subject-mask clip-subject-tracker campaign-tracker clip-beat-sync clipping-campaign-producer)
