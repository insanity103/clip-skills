...
2. **Unpack and install** (about 2 minutes):
   ...
   It copies the ten skills into `~/.claude/skills`, sets up `~/.venvs/clipkit`, and ends with a self-test.
   Two of the ten (`clip-subject-mask`, `clip-subject-tracker`) need a separate, much heavier PyTorch-based
